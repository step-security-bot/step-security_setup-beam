...
[action]: https://github.com/step-security/setup-beam/actions/workflows/action.yml
[action-img]: https://github.com/step-security/setup-beam/actions/workflows/action.yml/badge.svg
[ubuntu]: https://github.com/step-security/setup-beam/actions/workflows/ubuntu.yml
[ubuntu-img]: https://github.com/step-security/setup-beam/actions/workflows/ubuntu.yml/badge.svg
[windows]: https://github.com/step-security/setup-beam/actions/workflows/windows.yml
[windows-img]: https://github.com/step-security/setup-beam/actions/workflows/windows.yml/badge.svg
[macos]: https://github.com/step-security/setup-beam/actions/workflows/macos.yml
[macos-img]: https://github.com/step-security/setup-beam/actions/workflows/macos.yml/badge.svg
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: step-security/setup-beam@v1
        ...
```
